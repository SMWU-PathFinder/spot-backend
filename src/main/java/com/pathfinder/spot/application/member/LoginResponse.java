...
public record LoginResponse(Member member, String grantType, String accessToken, String refreshToken) {
    public static LoginResponse of(Member member, String accessToken, String refreshToken) {
        return new LoginResponse(member, "Bearer", accessToken, refreshToken);
    }
}
